...
class Login extends React.Component {
  ...
  render() {
    return (
      <Grid container>
        <Grid item xs={7}>
          <img className="image" alt="fruits&vegetablesImage" src='https://d2cb0q3n10x0un.cloudfront.net/assets/images/home/slider/Fresh-fnv_Mob.jpg' />
        </Grid>
        <Grid item xs={5} >
            ...
            <form onSubmit={this.loginUser}>
              ...
              <FormControl component="fieldset">
                ...
                <RadioGroup row aria-label="UserType" name="userType" value={this.state.userType} onChange={event => this.handleChange({userType: event.target.value})}>
                  ...
                  <FormControlLabel value="greengrocer" control={<Radio />} label="Greengrocer / Super Market" />
                </RadioGroup>
              </FormControl>
              <Button
                type="submit"
