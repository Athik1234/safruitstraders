...
import DisplayGreengrocer from "./mainpage/DisplayGreengrocer";
          ...
          <Grid item sm={9}>
            <div className="grid-item">
              <Switch>
                ...
                <Route path="/customer/greengrocer/:greengrocerId" render={props => <DisplayGreengrocer {...props} currentUser={this.props.currentUser} />} />
