...
import GreengrocerView from '../greengrocerView/GreengrocerView';
          ...
          <Grid item xs={12}>
            <div className="grid-main">
              <Switch>
                ...
                {this.state.userType && this.state.userType === "greengrocer" ? (
                  <Route path="/greengrocer" render={props => <GreengrocerView {...props} currentUser={this.state.currentUser} changeView={this.changeView} />} />
                ) : (
                  <Redirect path="/greengrocer" to="/login" />
                )}
                {!this.state.userType ? (
