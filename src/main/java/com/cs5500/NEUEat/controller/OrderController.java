...
import com.cs5500.FreshMart.exception.CommentAlreadyExistException;
import com.cs5500.FreshMart.exception.OrderAlreadyCheckoutException;
import com.cs5500.FreshMart.exception.OrderAlreadyDeliverException;
import com.cs5500.FreshMart.exception.OrderNotExistException;
...
public class OrderController {
  ...
  public int addOrderToCart(@RequestBody String jsonOrder) {
    ...
    String greengrocerId = order.getString("greengrocerId");
    JSONArray shopcart = order.getJSONArray("shopcart");
    Gson gson = new Gson();
    List<Item> list = new ArrayList<>();
    for (Object object : shopcart) {
      list.add(gson.fromJson(object.toString(), Item.class));
    }
    return orderService.addOrderToCart(customerId, greengrocerId, list);
  }
